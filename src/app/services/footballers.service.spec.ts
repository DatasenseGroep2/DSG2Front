...
describe('FootballersService', () => {
  ...
  it('should get a list of footballers', () => {
    const expectedFootballers = [
      { footballerId: 1, firstName: 'John', lastName: 'Doe', gender: 'male', team: 'P1', position: 'Forward', playerStatus: 2, dateOfBirth: new Date(), dominantFoot: "left", length: 1.87 },
      { footballerId: 2, firstName: 'Jane', lastName: 'Doe', gender: 'male', team: 'P1', position: 'Defender', playerStatus: 1, dateOfBirth: new Date(), dominantFoot: "right", length: 1.89 }
    ];
  ...
  it('should get a footballer by id', () => {
    const expectedFootballer = { footballerId: 1, firstName: 'John', lastName: 'Doe', gender: 'male', team: 'P1', position: 'Forward', playerStatus: 2, dateOfBirth: new Date(), dominantFoot: "left", length: 1.87 }
    ;
  ...
  it('should get a footballer\'s weight data', () => {
    const expectedWeights = [
      { dateOfWeight: new Date(2022, 0O1, 0O1, 23, 59, 59, 0), weight: 80, weightId: 1, footballerId: 1 },
      { dateOfWeight: new Date(2022, 0O1, 0O1, 23, 59, 59, 0), weight: 82, weightId: 2, footballerId: 2 }
    ];
